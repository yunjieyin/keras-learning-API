...
from TF.tf_tutorial.cnn_cifar10 import cifar10_input
FLAGS = tf.app.flags.FLAGS
# Basic model parameters.
tf.app.flags.DEFINE_integer('batch_size', 16, """Number of images to process in a batch.""")
tf.app.flags.DEFINE_string('data_dir', 'F:/dataSets/cifar10', """Path to the CIFAR-10 data directory.""")
...
def distorted_inputs():
  ...
  data_dir = "F:\dataSets\cifar10\cifar-10-batches-bin"

  train_inputs = cifar10_input.distorted_inputs(data_dir=data_dir, batch_size=16)
  return train_inputs
